...
public class PistasDragListener implements MouseListener, MouseMotionListener {
    ...
    public PistasDragListener(JList<Vuelo> listaOrigen, JList<Vuelo> listaDestino, JFrame ventanaPrincipal) {
    ...
    public PistasDragListener(JList<Vuelo> listaOrigen, List<JList<Vuelo>> listasDestino, JFrame ventanaPrincipal) {
        this.listaOrigen = listaOrigen;
    ...
    private void inicializarVentanaFlotante() {
        ...
        ventanaFlotante = new JWindow(ventanaPrincipal);
