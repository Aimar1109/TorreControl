...
// QUEDA POR AÑADIR LOS EJEMPLOS EN LA TABLA INFO DE LA PUERTA DE EMBARQUE Y DE LA PISTA
...
public class Main {
	...
	private static ArrayList<Vuelo> generarVuelosAleatorios(int cantidad) {
		...
		for (int i = 0; i < cantidad; i++) {
			...
			Pista pista = new Pista(ciudadDestino, false);
			PuertaEmbarque puerta = new PuertaEmbarque(ciudadDestino, false);
